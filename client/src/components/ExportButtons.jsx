...
export default function ExportButtons({ snippets }) {
  ...
  return (
    <div className="export-bar">
      ...
      <button className="export-button" onClick={handleTXT} title="Download as plain text">
      ...
      <button className="export-button" onClick={handleSRT} title="Download as subtitle file">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
