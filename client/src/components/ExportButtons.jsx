...
export default function ExportButtons({ snippets }) {
  ...
  return (
    <>
      <button className="action-btn" onClick={handleTXT} title="Download as plain text">
      ...
      <button className="action-btn" onClick={handleSRT} title="Download as subtitle file">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
